const Hollywood_data = (req,res)=>{
    res.send(([ 
        {id:1, 
          ide: 1,
          cat: "Hollywood",
          for: "ArticleList",
          Overview:'Ant-Mannnn  and the Wasp find themselves exploring the Quantum Realm, interacting with strange new creatures and embarking on an adventure that pushes them beyond the limits of what they thought was possible.', 
...
module.exports = {Bollywood_data, Hollywood_data, Technology_data, Fitness_data, Food_data}